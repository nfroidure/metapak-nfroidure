...
module.exports = (packageConf) => {
  ...
  packageConf.devDependencies['@babel/cli'] = '^7.12.1';
  packageConf.devDependencies['@babel/core'] = '^7.12.3';
  packageConf.devDependencies['@babel/register'] = '^7.12.1';
  packageConf.devDependencies['@babel/preset-env'] = '^7.12.1';
  ...
  if (configs.includes('typescript')) {
    ...
    packageConf.devDependencies['@babel/preset-typescript'] = '^7.12.1';
