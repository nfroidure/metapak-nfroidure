...
describe('Assets transformer for www configs', () => {
  ...
  test('should build the README.md file', async () => {
    ...
    expect(file).toMatchInlineSnapshot(`
      ...
      [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/nfroidure/module/blob/master/LICENSE)
  ...
  test('should build the README.md file with additional badges', async () => {
    ...
    expect(file).toMatchInlineSnapshot(`
      ...
      [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/nfroidure/module/blob/master/LICENSE)
      [![Build status](https://travis-ci.com/nfroidure/module.svg?branch=master)](https://travis-ci.com/github/nfroidure/module)
      [![Coverage Status](https://coveralls.io/repos/github/nfroidure/module/badge.svg?branch=master)](https://coveralls.io/github/nfroidure/module?branch=master)
  ...
  test('should work with scoped packages', async () => {
    ...
    expect(file).toMatchInlineSnapshot(`
      ...
      [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/nfroidure/scope-module/blob/master/LICENSE)
      [![Build status](https://travis-ci.com/nfroidure/module.svg?branch=master)](https://travis-ci.com/github/nfroidure/module)
      [![Coverage Status](https://coveralls.io/repos/github/nfroidure/module/badge.svg?branch=master)](https://coveralls.io/github/nfroidure/module?branch=master)
      ...
      # License
      [MIT](https://github.com/nfroidure/scope-module/blob/master/LICENSE)
      ",
        "dir": "/home/whoami/project/dir",
        "name": "README.md",
      }
  ...
  test('should work with scoped packages inside a monorepo', async () => {
    ...
    expect(file).toMatchInlineSnapshot(`
      ...
      [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/nfroidure/scope/blob/master/packages/scope-module/LICENSE)
      [![Build status](https://travis-ci.com/nfroidure/module.svg?branch=master)](https://travis-ci.com/github/nfroidure/module)
      [![Coverage Status](https://coveralls.io/repos/github/nfroidure/module/badge.svg?branch=master)](https://coveralls.io/github/nfroidure/module?branch=master)
      ...
      # License
      [MIT](https://github.com/nfroidure/scope/blob/master/packages/scope-module/LICENSE)
      ",
        "dir": "/home/whoami/project/dir",
        "name": "README.md",
      }
